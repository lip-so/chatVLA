#!/usr/bin/env python3
"""
Comprehensive hardware communication bridge for so100 robot
...
class ComprehensiveHardwareBridge:
    def __init__(self, robot_type="so100"):
        ...
        self.config = {'dof': 5, 'type': 'desktop_arm', 'description': 'SO-100 Follower (5-DOF desktop arm)', 'baud_rate': 1000000, 'port_pattern': '/dev/ttyUSB*'}
