#!/usr/bin/env python3
"""
Comprehensive hardware communication bridge for so101 robot
...
class ComprehensiveHardwareBridge:
    def __init__(self, robot_type="so101"):
        ...
        self.config = {'dof': 6, 'type': 'precision_arm', 'description': 'SO-101 Follower (6-DOF precision arm)', 'baud_rate': 1000000, 'port_pattern': '/dev/ttyUSB*'}
